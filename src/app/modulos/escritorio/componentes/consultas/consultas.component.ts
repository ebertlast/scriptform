...
import { Rep } from '../../../reportes/modelos/rep';
import { Repp } from '../../../reportes/modelos/repp';
import { RepService } from '../../../reportes/servicios/rep.service';
import { ReppService } from '../../../reportes/servicios/repp.service';
...
export class ConsultasComponent implements OnInit {
  ...
  constructor(private _repService: RepService, private _reppService: ReppService) { }
  ...
  ngOnInit() {
    ...
    jQuery(function ($) {
      ...
      // $.fn.dataTable.Buttons.swfPath = "../assets/components/datatables.net-buttons-swf/index.swf"; //in Ace demo ../components will be replaced by correct assets path
